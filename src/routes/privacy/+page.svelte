<script lang="ts">
	...
	import LegalPage from '$lib/layouts/LegalPage.svelte';
	...
	<ul>
		...
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to Focus.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Focus, accessible from
				<a
					href="https://focus.gaunt.dev"
					rel="external nofollow noreferrer noopener"
					target="_blank">https://focus.gaunt.dev</a
				>
			</p>
		</li>
		<li>
